  ...
  return (
    <div className="drawer lg:drawer-open fixed top-0 left-0">
      ...
      <div className="drawer-side">
        ...
        <ul className="w-36 lg:w-[88px] h-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-60 lg:bg-opacity-20 flex flex-col justify-around items-center">
          {icons.map((icon) => (
            <li>
              <Buttons
